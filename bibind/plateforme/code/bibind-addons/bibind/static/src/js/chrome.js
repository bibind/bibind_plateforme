...
instance.web.Dialog.include({
    ...
    */
    open: function() {
        ...
        this.$buttons.insertAfter(this.$dialog_box.find(".mdc-dialog__footer"));
    ...
    */
    init_dialog: function() {
        ...
        this.$dialog_box = $(QWeb.render('mdc-Dialog', options)).prependTo(".content-wraper");
        id = this.$dialog_box.attr('id')
        console.log('id')
        console.log(id)
        this.mdcdialog = new mdc.dialog.MDCDialog(document.querySelector('#'+id));
        ...
        this.$el.appendTo(this.$dialog_box.find(".mdc-modal-body"));
        var $dialog_content = this.$dialog_box.find('.mdc-modal-content');
        ...
        //this.mdcdialog.lastFocusedTarget = document.querySelector('s.content-wraper')
        this.mdcdialog.show();
...
instance.web.CrashManager = instance.web.Class.extend({
    ...
    show_warning: function(error) {
        ...
        new instance.web.Dialog(this, {
            size: 'medium',
            title: "Bibind " + (_.str.capitalize(error.type) || "Warning"),
            buttons: [
...
instance.web.WebClient = instance.web.Client.extend({
    ...
    */
    ...
    show_application: function() {
        ...
        self.set_title();
        self.check_timezone();
        console.log('webclient show appl')
    	console.log(self)
        if (self.client_options.action_post_login) {
        	console.log('webclient action manager')
        	console.log(self.action_manager)
        ...
        return this.menu_dm.add(this.rpc("/web/action/load", { action_id: options.action_id }))
            .then(function (result) {
                return self.action_mutex.exec(function() {
                    ...
                    console.log("faile")
                	console.log(self.action_manager.do_action(result, {
                    ...
                    $.when(self.action_manager.do_action(result, {
                        ...
                        action_menu_id: self.menu.current_menu,
                    	 ...
                    	 console.log("faile")
                    	console.log(options.previous_menu_id)
